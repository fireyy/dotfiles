...
var UserSettings = (function () {
    function UserSettings() {
        ...
        this.Markers = new MarkersSettingEntry("markers", ['TODO:', 'Todo:', 'todo:']);
        // Turn on/off dev mode
        this.DevMode = new DevModeSettingEntry("devMode", false);
    ...
    UserSettings.prototype.reload = function () {
        ...
        var toLoad = [this.Exclusions, this.Inclusions, this.Markers, this.FolderExclusions, this.Only, this.DevMode];
        if (settings) {
...
var DevModeSettingEntry = (function (_super) {
    __extends(DevModeSettingEntry, _super);
    function DevModeSettingEntry() {
        _super.apply(this, arguments);
    }
    return DevModeSettingEntry;
}(SettingEntry));
exports.DevModeSettingEntry = DevModeSettingEntry;
