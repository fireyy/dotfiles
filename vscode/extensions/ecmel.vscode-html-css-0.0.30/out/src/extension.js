...
function activate(context) {
    ...
    context.subscriptions.push(vsc.languages.registerCompletionItemProvider(['html', 'laravel-blade', 'razor', 'vue'], styleServer));
    context.subscriptions.push(vsc.languages.registerHoverProvider(['html', 'laravel-blade', 'razor', 'vue'], styleServer));
    let classServer = new ClassServer();
    context.subscriptions.push(vsc.languages.registerCompletionItemProvider(['html', 'laravel-blade', 'razor', 'vue'], classServer));
